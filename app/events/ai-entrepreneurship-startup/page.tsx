      ...
      <section className="relative isolate px-6 pb-24 pt-32 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-12 space-y-4">
            ...
            <span className="inline-block text-xs uppercase tracking-[0.35em] text-zelvora-primary font-bold">Entrepreneurship Workshop</span>
            <h1 className="text-4xl font-extrabold leading-tight text-white sm:text-5xl lg:text-6xl">
              AI for Entrepreneurship & Startup
            </h1>
            <p className="text-lg text-zelvora-secondary">
              Empowering the next generation of innovators and founders
            </p>
          </div>
          ...
          <div className="grid gap-6 mb-12 sm:grid-cols-3">
            <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
              <span className="text-[10px] uppercase tracking-wider text-zelvora-primary font-bold">Focus Area</span>
              <p className="text-lg font-bold text-white mt-2 flex items-center gap-2"><FaMapMarkerAlt size={14} className="text-cyan-400" /> Startups & Ideas</p>
            </div>
            <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
              <span className="text-[10px] uppercase tracking-wider text-zelvora-primary font-bold">Event Type</span>
              <p className="text-lg font-bold text-white mt-2 flex items-center gap-2"><FaGraduationCap size={16} className="text-cyan-400" /> Workshop & Training</p>
            </div>
            <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="glass-card p-8 h-64 flex flex-col items-center justify-center rounded-3xl relative overflow-hidden group">
                ...
                <div className="text-center relative z-10 space-y-3">
                  ...
                  <p className="text-sm font-semibold text-white">Innovation Panels</p>
              ...
              <div className="glass-card p-8 h-64 flex flex-col items-center justify-center rounded-3xl relative overflow-hidden group">
                ...
                <div className="text-center relative z-10 space-y-3">
                  <div className="text-4xl transition-transform duration-500 group-hover:scale-110">💡</div>
                  <p className="text-sm font-semibold text-white">Pitch Deck Labs</p>
                  <p className="text-xs text-zelvora-secondary">Photos coming soon...</p>
                </div>
              </div>
            </div>
          ...
          <div className="glass-card p-8 sm:p-10 mb-12 rounded-[2.5rem]">
            ...
            <p className="text-base leading-8 text-zelvora-secondary mb-8">
              This specialized workshop bridges the gap between AI technology and entrepreneurial success. We empower aspiring founders with the knowledge and tools to leverage AI for rapid prototyping, business growth, and market optimization.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="flex gap-3 items-start text-sm text-zelvora-secondary">
                  <FaCheckCircle className="text-zelvora-primary mt-0.5 flex-shrink-0" />
                  <span>Building AI-powered prototypes</span>
                </div>
                <div className="flex gap-3 items-start text-sm text-zelvora-secondary">
                  <FaCheckCircle className="text-zelvora-primary mt-0.5 flex-shrink-0" />
                  <span>Startup strategy with AI automation</span>
                </div>
                <div className="flex gap-3 items-start text-sm text-slate-300">
                  <FaCheckCircle className="text-zelvora-primary mt-0.5 flex-shrink-0" />
                  <span>Pitching and funding strategies for AI startups</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 border-t border-cyan-300/10 pt-8 justify-between items-center">
            <p className="text-xs text-zelvora-secondary">Ready to launch your AI startup journey?</p>
